...
st.executeUpdate("update account set amount=amount+"+(fare)+" where accno='555444333'");
st.executeUpdate("delete from reservation where cname='"+cname+"' and bid='"+bid+"' and doj='"+date+"'");
